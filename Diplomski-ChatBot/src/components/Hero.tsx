  ...
  return (
    ...
    <section className="Home_about__3GJD3">
      <div>
        ...
        <img src="src\assets\983e5ea63a3746c013a7e53e4003c924.png" alt="AI Chatbot: Ask and Talk to AI about Anything" />
      </div>
      <div>
        <div>
            ...
            <img src="src\assets\77f765a69bf9303cd393200c7b553433.png" alt="Chat with AI-Powerd Character Asistants"/></div>
    </section>

    <section className="Home_feature__2hbt-">
        ...
        <div className="Home_featureList__3yC4P">
            <span><i className="iconfont icon-robot">
            </i>GPT powers our AI chatbot, delivering high-quality and expert-level content.</span>
            <span> <i className="iconfont icon-easy"></i>Easily accessible online, our AI chat website is both free and user-friendly.</span>
