...
import { sendEmail } from '../logic/api';
...
function Hero({ handleRegisterClick }: Readonly<HeroProps>) {
  useEffect(() => {
    AOS.init({
      duration: 1500,
  ...
  const handleEmail = async (event: { preventDefault: () => void }) => {
    ...
    <div className="Home_container_13EVf" id="homeContainer">
      ...
      <section className="Home_about__3GJD3">
        <div>
          <div>
            ...
            <span>
              Besplatan četbot od strane Cube-BOT-a koji može odgovoriti na sva vaša pitanja. Korisniku prijateljski nastrojen i jednostavan za interakciju, samo unesite svoje pitanje i dobijte
              odgovor. Isprobajte ga sada i vidite kako vam može pomoći!
            </span>
        ...
        <div>
          <div>
            ...
            <span>
              Cube-BOT nudi različite AI modele koji mogu pružiti informativne razgovore o različitim temama, uključujući obrazovanje, karijeru, poslovanje, način života i još mnogo toga. Bez obzira
              da li vam je potrebna pomoć u učenju jezika, sticanju znanja, poslovnim strategijama ili zdravijem načinu života, naš četbot je tu za vas.
            </span>
            <button className="href" onClick={preventLogin}>
              Četuj sada &gt;
            </button>
          </div>
          <img src="src/assets/2.png" alt="Chat with AI-Powerd Character Asistants" />
        </div>
      </section>
      ...
      <section className="Home_feature__2hbt-" data-aos="zoom-in">
        ...
        <div className="Home_featureList__3yC4P">
          <span>
            {' '}
            <FontAwesomeIcon icon={faRobot as IconProp} style={{ color: '#646cff' }} /> GPT i Llama modeli pokreću našeg AI četbota, pružajući visokokvalitetan sadržaj na stručnom nivou.
          </span>
          <span>
            {' '}
            <FontAwesomeIcon icon={faCogs as IconProp} style={{ color: '#646cff' }} /> Lako dostupna na mreži, naša veb stranica za AI čet je besplatna i jednostavna za korišćenje.
          </span>
          <span>
            {' '}
            <FontAwesomeIcon icon={faShieldAlt as IconProp} style={{ color: '#646cff' }} />
            Dajući prioritet sigurnosti informacija, Cube-BOT garantuje zaštitu podataka.
          </span>
        </div>
      </section>
      <section id="pricingContainer" style={{ margin: '50px auto 0', padding: '550px 20px' }} data-aos="flip-right" data-aos-delay="550">
        <div className="pricing-section">
          ...
          <PricingTable highlightColor="#ffd700">
            <PricingSlot buttonText="Registruj se" onClick={handleRegisterClick} title="Besplatan Plan" priceText="$0/Month">
              <PricingDetail>
                {' '}
                <div>Cena: $0</div>{' '}
              </PricingDetail>
              <PricingDetail>
                {' '}
                <div>Basic features included</div>{' '}
              </PricingDetail>
              <PricingDetail>
                {' '}
                <div>100 promptova/mesečno</div>{' '}
              </PricingDetail>
            </PricingSlot>
            <PricingSlot buttonText="Registruj se" onClick={handleRegisterClick} title="Pro Plan" priceText="$9.99">
              <PricingDetail>
                {' '}
                <div>Cena: $9.99</div>{' '}
              </PricingDetail>
              <PricingDetail>
                {' '}
                <div>Svi sadržaji uključeni</div>{' '}
              </PricingDetail>
              <PricingDetail>
                {' '}
                <div>5000 promptova/mesečno</div>{' '}
              </PricingDetail>
            </PricingSlot>
            <PricingSlot buttonText="Registruj se" onClick={handleRegisterClick} title="Biznis Plan" priceText="$19.99">
              <PricingDetail>
                {' '}
                <div>Cena: $19.99</div>{' '}
              </PricingDetail>
              <PricingDetail>
                {' '}
                <div>Prioritetna podrška</div>{' '}
              </PricingDetail>
              <PricingDetail>
                {' '}
                <div>Neograničeno promptova/mesečno</div>{' '}
              </PricingDetail>
            </PricingSlot>
          </PricingTable>
        </div>
        ...
        <div className="Contact1">
          <div className="Contact2">
            <div className="Contact3">
              ...
              <p>
                Trazite premijum plan?{' '}
                <a href="mailto:cvetkovicmladen00@gmail.com" className="dRExZB">
                  Kontaktirajte nas
                </a>{' '}
                ili pogledajte
      ...
      <section className="About_feature" id="aboutContainer" data-aos="fade-up">
        <div className="About_feature_container">
          ...
          <div className="About_feature_text">
            <h2>O Cube-BOT-u :</h2>
            <p>
              Cube-BOT je revolucionarni AI četbot dizajniran da pruži duboke i informativne razgovore. Sa najsavremenijom tehnologijom i korisnički prijateljskim interfejsom, Cube-BOT je tu da
              odgovori na vaša pitanja, pomogne vam u vašem procesu učenja i pruži kreativnu inspiraciju. Naš cilj je da vaši interakcije sa Cube-BOT budu prijatne i obogaćujuće, pomažući vam da
              postignete više u manje vremena.
            </p>
          </div>
        </div>
        <div className="About_feature_extra">
          ...
          <div className="About_feature_extra_item">
            <h3>Naša Misija</h3>
            <p>
              Naša misija je osnažiti pojedince AI tehnologijom koja poboljšava njihovu produktivnost, učenje i kreativnost. Trudimo se da predstavimo AI četbota koji ne samo da odgovara na pitanja,
              već i inspiriše i pomaže korisnicima da postignu svoje ciljeve.
            </p>
          </div>
        </div>
      </section>
